...
public static class TrucActionScoreTable
{
    ...
    {
        // Row 0 (Kiến): [NHAP_TRACH, SUA_NHA, NHAN_VIEC, MUA_VANG, MUA_DAT, KHAI_TRUONG, KY_HOP_DONG, DAM_BAO_HANH, XUAT_HANH, CU_HUONG, BAT_DAU, CHUA_BENH, TAM_SOAT, KHAI_VONG, THI_DAU, AN_TANG, BOC_MO, THO_MAU, LE_BAI, CAT_SAC, TU_TUC, XAY_NHA, CUOI_HOI, SINH_CON, MUA_XE]
